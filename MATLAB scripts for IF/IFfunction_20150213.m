...
function[intintdapi_allwells, avgnuccy3_allwells, avgnuccy5_allwells, wellName]= IFfunction(row,col, dir)
...
for site=2:16  %number of sites
   site
    ...
    dapimask=getdapimask(dapi, 26);  %radius=26 is good for20x no bin 20150211MCF10A. 19 for Hs68. the number after the comma is the nuclear RADIUS (not diameter);whole numbers only
