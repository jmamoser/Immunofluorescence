...
load('Y:\IXMicroImages-goodNames\Mansi\MICROSCOPY DATA\Fixed Cell imaging\MA70-p21nullvsWT-IF\analyzedData_10Xpuncta\3_3_data.mat')
...
load('Y:\IXMicroImages-goodNames\Mansi\MICROSCOPY DATA\Fixed Cell imaging\MA70-p21nullvsWT-IF\analyzedData_10Xpuncta\4_3_data.mat')
...
% % 
load('Y:\IXMicroImages-goodNames\Mansi\MICROSCOPY DATA\Fixed Cell imaging\MA70-p21nullvsWT-IF\analyzedData_10Xpuncta\6_3_data.mat')
% % load('Y:\IXMicroImages-goodNames\Mansi\MA57 IF for hypoxia\MA57-20160309-20pctO2day10-p21prb_1420\analyzedData_10Xpuncta\1_3_data.mat')
...
% % 
load('Y:\IXMicroImages-goodNames\Mansi\MICROSCOPY DATA\Fixed Cell imaging\MA70-p21nullvsWT-IF\analyzedData_10Xpuncta\7_3_data.mat')
...
AvgPunctaIntensity_allwells=[AvgPunctaIntensity_allwells1 AvgPunctaIntensity_allwells2 AvgPunctaIntensity_allwells3 ];
% centroid_allwells=[centroid_allwells1 centroid_allwells2];
intintdapi_allwells=[intintdapi_allwells1 intintdapi_allwells2 intintdapi_allwells3 ];
puncta_allwells=[puncta_allwells1 puncta_allwells2 puncta_allwells3 ];
sitelist_allwells=[sitelist_allwells1 sitelist_allwells2 sitelist_allwells3  ];
SumPunctaArea_allwells=[SumPunctaArea_allwells1 SumPunctaArea_allwells2 SumPunctaArea_allwells3 ];
SumPunctaMetric_allwells=[SumPunctaMetric_allwells1 SumPunctaMetric_allwells2 SumPunctaMetric_allwells3 ];
...
G0G1cellsI=find(intintdapi_allwells <4.0e6);
ScellsI=find(intintdapi_allwells >4.8e6 & intintdapi_allwells <5.13e6);
G2McellsI=find(intintdapi_allwells >=5.13e6);
...
figure(400)  
histogram(log10(avgnucfitc_allwells),100)
...
figure(4)  
subplot(4,1,1)
hist(log10(avgnucfitc_allwells),100)
xlabel('pRb in all cells')
xlim([2.4 5])

subplot(4,1,2)
hist(log10(avgnucfitc_allwells(G0G1cellsI)),100)
xlabel('pRb in G0/G1 cells')
xlim([2.4 5])

subplot(4,1,3)
hist(log10(avgnucfitc_allwells(ScellsI)),100)
xlabel('pRb in S phase cells')
xlim([2.4 5])

subplot(4,1,4)
hist(log10(avgnucfitc_allwells(G2McellsI)),100)
...
xlim([3.2 5])
subplot(4,1,2)
hist(log10(avgnucfitc_allwells(puncta0I)),100)
xlabel('pRb in all cells with 0 puncta')
xlim([3.2 5])
subplot(4,1,3)
hist(log10(avgnucfitc_allwells(puncta1I)),100)
xlabel('pRb in all cells with 1 puncta')
xlim([3.2 5])
subplot(4,1,4)
hist(log10(avgnucfitc_allwells(puncta2ormoreI)),100)
...
xlim([3.2 5])
subplot(4,1,2)
hist(log10(avgnucfitc_allwells(puncta0_G0G1cellsI)), 100)
xlabel('pRb in G0/G1 cells with 0 puncta')
xlim([3.2 5])
subplot(4,1,3)
hist(log10(avgnucfitc_allwells(puncta1_G0G1cellsI)),100)
xlabel('pRb in G0/G1 cells with 1 puncta')
xlim([3.2 5])
subplot(4,1,4)
hist(log10(avgnucfitc_allwells(puncta2ormore_G0G1cellsI)),100)
...
subplot(4,1,4)
hist(log10(avgnucfitc_allwells(puncta1ormore_G0G1cellsI)), 100)
