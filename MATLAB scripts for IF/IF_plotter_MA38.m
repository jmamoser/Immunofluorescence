...
load('G:\Microscopy data\Project 1 - CDK2 status in cells forced into quiescence - IF data\MA38-20150812-53BP1-forcedQ_547\analyzedData_puncta\2_2_data.mat')
% avgnuccy3_allwells1=avgnuccy3_allwells;
% avgnucfitc_allwells1=avgnucfitc_allwells;
intintdapi_allwells1=intintdapi_allwells;

load('G:\Microscopy data\Project 1 - CDK2 status in cells forced into quiescence - IF data\MA38-20150812-53BP1-forcedQ_547\analyzedData_puncta\2_3_data.mat')
% avgnuccy3_allwells2=avgnuccy3_allwells;
% avgnucfitc_allwells2=avgnucfitc_allwells;
intintdapi_allwells2=intintdapi_allwells;
% % 
load('G:\Microscopy data\Project 1 - CDK2 status in cells forced into quiescence - IF data\MA38-20150812-53BP1-forcedQ_547\analyzedData_puncta\2_6_data.mat')
% avgnuccy3_allwells3=avgnuccy3_allwells;
% avgnucfitc_allwells3=avgnucfitc_allwells;
intintdapi_allwells3=intintdapi_allwells;
% % 
load('G:\Microscopy data\Project 1 - CDK2 status in cells forced into quiescence - IF data\MA38-20150812-53BP1-forcedQ_547\analyzedData_puncta\2_9_data.mat')
% avgnuccy3_allwells4=avgnuccy3_allwells;
% avgnucfitc_allwells4=avgnucfitc_allwells;
intintdapi_allwells4=intintdapi_allwells;

load('G:\Microscopy data\Project 1 - CDK2 status in cells forced into quiescence - IF data\MA38-20150812-53BP1-forcedQ_547\analyzedData_puncta\2_10_data.mat')
...
subplot (5, 1, 2)
hist(intintdapi_allwells2,1000)
xlabel('starved')
xlim([0 4e7])
