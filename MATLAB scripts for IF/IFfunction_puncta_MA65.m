...
%     avgnuccy3_allwells=[avgnuccy3_allwells, avgnuccy3];  %put all 9 wells together
    ...
    clear avgnucfitc; clear avgnuccy5; clear sumnucdapi;  clear puncta; clear SumPunctaArea; clear AvgPunctaIntensity; clear SumPunctaMetric; clear center; clear presentsite; 
