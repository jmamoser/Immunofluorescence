...
load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\3_2_data.mat')
avgnuccy5_allwells1=avgnuccy5_allwells;
intintdapi_allwells1=intintdapi_allwells;


load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\3_3_data.mat')
avgnuccy5_allwells2=avgnuccy5_allwells;
intintdapi_allwells2=intintdapi_allwells;
% % 
load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\3_4_data.mat')
avgnuccy5_allwells3=avgnuccy5_allwells;
intintdapi_allwells3=intintdapi_allwells;
% % 
load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\3_5_data.mat')
...
load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\6_2_data.mat')
avgnuccy5_allwells5=avgnuccy5_allwells;
intintdapi_allwells5=intintdapi_allwells;

load('Y:\IXMicroImages-goodNames\Mansi\MA64-20160621-p21IF-16sites_1715\analyzedData\6_3_data.mat')
...
figure(400)
subplot(2,1,1)
hist(log10(avgnuccy5_allwells_low),100)
xlabel('OPP in p21__low cells (log)')
xlim([2.5 5])

subplot(2,1,2)
hist(log10(avgnuccy5_allwells_high),100)
xlabel('OPP in p21__high cells (log)')
xlim([2.5 5])
