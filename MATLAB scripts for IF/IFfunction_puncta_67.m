...
function[intintdapi_allwells, avgnucfitc_allwells, avgnuccy5_allwells, centroid_allwells, sitelist_allwells, wellName, puncta_allwells, SumPunctaArea_allwells, AvgPunctaIntensity_allwells, SumPunctaMetric_allwells] = IFfunction_puncta(row,col, dir, savingdir)
...
punctasize_lowerlimit=3;  %punctasize_lowerlimit is the minimum number of pixels that a puncta can be;  3 is good for 20X and no binning
nuclearradius=12;
strelradius=4;       %this is the number of pixels around the puncta to take as background, which will get subtracted
getdapimaskradius=4;  %this is a guess at the radius of a typical puncta
...
%     avgnuccy3_allwells=[avgnuccy3_allwells, avgnuccy3];  %put all 9 wells together
    ...
    puncta_allwells = [puncta_allwells,puncta'];
     ...
     clear avgnuccy5; clear sumnucdapi;  clear puncta; clear SumPunctaArea; clear AvgPunctaIntensity; clear SumPunctaMetric; clear center; clear presentsite; clear avgnucfitc
