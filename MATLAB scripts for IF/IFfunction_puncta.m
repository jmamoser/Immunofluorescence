...
function[intintdapi_allwells,avgnucfitc_allwells,  avgnuccy3_allwells, avgnuccy5_allwells, centroid_allwells, sitelist_allwells, wellName, puncta_allwells, SumPunctaArea_allwells, AvgPunctaIntensity_allwells, SumPunctaMetric_allwells] = IFfunction_puncta(row,col, dir, savingdir)

puncta_sizethreshold=0.2;  %any "puncta" greater than 20% of the nuclear area will be rejected as a puncta
punctasize_lowerlimit=1;  %punctasize_lowerlimit is the minimum number of pixels that a puncta can be;  3 is good for 20X and no binning
nuclearradius=12;
strelradius=5;       %this is the number of pixels around the puncta to take as background, which will get subtracted
getdapimaskradius=2;  %this is a guess at the radius of a typical puncta
...
for site=1:9  %for each of my 9 images
    ...
    punctaimage=cy3;  %in this case, 53BP1 puncta are in the cy3 channel
    ...
    clear avgnuccy3; clear avgnuccy5; clear sumnucdapi;  clear puncta; clear SumPunctaArea; clear AvgPunctaIntensity; clear SumPunctaMetric; clear center; clear presentsite; clear avgnucfitc
