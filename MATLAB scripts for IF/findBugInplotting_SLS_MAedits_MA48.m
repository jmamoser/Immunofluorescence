...
dapiweirdI=[];
dapiweirdI=find(intintdapi_allwells < 5.6e5 | intintdapi_allwells > 2.2e6);  %indices for cells with too high or too low DNA content
...
G0G1cellsI=find(log10(avgnuccy5_allwells) <2.5 & intintdapi_allwells <1.2e6);
ScellsI=find(log10(avgnuccy5_allwells) > 2.7);
G2McellsI=find(log10(avgnuccy5_allwells) <2.5 & intintdapi_allwells >1.3e6);
