...
load('Y:\IXMicroImages-goodNames\Mansi\MA62-20160519-APH_1633\analyzedData_10Xpuncta\4_7_data.mat')
avgnuccy3_allwells2=avgnuccy3_allwells;
avgnucfitc_allwells2=avgnucfitc_allwells;
intintdapi_allwells2=intintdapi_allwells;
% % 
load('Y:\IXMicroImages-goodNames\Mansi\MA62-20160519-APH_1633\analyzedData_10Xpuncta\3_7_data.mat')
...
subplot(4,1,4)
hist(intintdapi_allwells4, 10000)
xlabel('MEKi')
xlim([0 1E7])
